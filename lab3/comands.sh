...
gcloud compute --project=$PROJECT_ID networks create managementnet --subnet-mode=custom

gcloud compute --project=$PROJECT_ID networks subnets create managementsubnet-us --network=managementnet --region=us-central1 --range=10.130.0.0/20
